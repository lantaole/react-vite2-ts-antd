...
const Home = () => {
  ...
  useEffect(() => {
    getBannerList().then(res => {
      setBanners(res.data);
      dispatch(changeTopBg(res.data[0].css.backgroundColor))
    })
  }, []);
  return (
    <>
      <div className={styles.homeWrapper} >
        <Carousel
          ...
          beforeChange={(from, to) => {
            console.log(from);
            console.log(to);
            dispatch(changeTopBg(banners[to].css.backgroundColor))
          }}
          // afterChange={(current) =>  dispatch(changeTopBg(banners[current].css.backgroundColor))}
          dots={{className: 'carousel-move-style'}}
        >
          {
        ...
        <div className={styles.muyeHomeNotice}>
          ...
          <div className={styles.muyeHomeNoticeBlock}>
            <div className="common-title"><p>最新资讯</p><a target="_blank" href="/writer/zone/notice">更多<i
              className="muyeicon-enter"></i></a></div>
            <div className="muye-home-notice-block-list"><a
              href="https://fanqienovel.com/writer/zone/article/7154265360449929224" target="_blank">专访 |
              77w人在追“御兽文”作者三风11</a><a href="https://fanqienovel.com/writer/zone/article/7153138098488999972"
                                                target="_blank">章节植入广告功能上线通知</a><a
              href="https://fanqienovel.com/writer/zone/article/7152835257312477198" target="_blank">18期|直播预告
              专访人气作者王信</a><a href="https://fanqienovel.com/writer/zone/article/7149101743404482591"
                                     target="_blank">专访 | 作者冯一病：彷徨岁月里扎入网文行业写修仙</a></div>
          </div>
        </div>
      </div>
